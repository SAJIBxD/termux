...
let s:colors = {
      ...
      \ "dark_red": get(s:overrides, "dark_red", { "gui": "#cb5760", "cterm": "196", "cterm16": "9" }),
      ...
      \ "comment_grey": get(s:overrides, "comment_grey", { "gui": "#474e5b", "cterm": "59", "cterm16": "15" }),
      \ "gutter_fg_grey": get(s:overrides, "gutter_fg_grey", { "gui": "#4B5263", "cterm": "238", "cterm16": "15" }),
      \ "cursor_grey": get(s:overrides, "cursor_grey", { "gui": "#2b2f37", "cterm": "236", "cterm16": "8" }),
      \ "visual_grey": get(s:overrides, "visual_grey", { "gui": "#3E4452", "cterm": "237", "cterm16": "15" }),
      \ "menu_grey": get(s:overrides, "menu_grey", { "gui": "#2b2f37", "cterm": "237", "cterm16": "8" }),
      \ "special_grey": get(s:overrides, "special_grey", { "gui": "#3B4048", "cterm": "238", "cterm16": "15" }),
      \ "vertsplit": get(s:overrides, "vertsplit", { "gui": "#2b2f37", "cterm": "59", "cterm16": "15" }),
      \}
